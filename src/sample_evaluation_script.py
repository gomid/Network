...
file_name = ['Question_2/dw-100-40-4.csv', 'Question_2/db-100-40-4.csv', 'Question_2/dw-28-6-4.csv',
             'Question_2/db-28-6-4.csv', 'Question_2/dw-14-28-4.csv', 'Question_2/db-14-28-4.csv']
true_file = ['true-dw-100-40-4.csv', 'true-db-100-40-4.csv', 'true-dw-28-6-4.csv', 'true-db-28-6-4.csv',
             'true-dw-14-28-4.csv', 'true-db-14-28-4.csv']
threshold = 0.05
